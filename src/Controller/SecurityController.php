...
class SecurityController extends AbstractController
{
    ...
    public function register(Request $request, UserPasswordEncoderInterface $passwordEncoder): Response
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            $participant->setSiteAffiliation($this->getDoctrine()->getRepository('App\Entity\Sites')->findOneBy(['idSite' => $request->request->get('siteAffiliation')]));
    ...
    /**
     * @Route("/forgotten_password", name="userForgottenPassword")
     */
    ...
    /**
    * @Route("/reset_password/{token}", name="userResetPassword")
    */
